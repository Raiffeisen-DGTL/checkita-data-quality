package org.checkita.core.streaming

import eu.timepit.refined.api.Refined
import eu.timepit.refined.auto._
import org.scalatest.matchers.should.Matchers
import org.scalatest.wordspec.AnyWordSpec
import org.checkita.Common.{jobId, spark}
...
import org.checkita.core.metrics.rdd.RDDMetricProcessor.GroupedCalculators
import org.checkita.core.metrics.rdd.regular.AlgebirdRDDMetrics.HyperLogLogRDDMetricCalculator
import org.checkita.core.metrics.rdd.regular.BasicNumericRDDMetrics.{StdAvgNumberRDDMetricCalculator, TDigestRDDMetricCalculator}
import org.checkita.core.metrics.rdd.regular.BasicStringRDDMetrics.RegexMatchRDDMetricCalculator
...
import org.checkita.utils.Common.getStringHash
import org.checkita.utils.ResultUtils.liftToResult
