package org.checkita.config.validation

import pureconfig.generic.semiauto.{deriveReader, deriveWriter}
import pureconfig.{ConfigReader, ConfigWriter}
import org.checkita.config.Enums.TrendCheckRule
import org.checkita.config.appconf.StreamConfig
import org.checkita.config.jobconf.Checks._
import org.checkita.config.jobconf.MetricParams.LevenshteinDistanceParams
import org.checkita.config.jobconf.Sources._
import org.checkita.config.Parsers.ExpressionParsingOps
import org.checkita.config.jobconf.Schemas.RegistrySchemaConfig
