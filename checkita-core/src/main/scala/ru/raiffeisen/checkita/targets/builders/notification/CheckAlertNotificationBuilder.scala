...
import ru.raiffeisen.checkita.config.jobconf.Outputs.NotificationOutputConfig
import ru.raiffeisen.checkita.config.jobconf.Targets.CheckAlertTargetConfig
...
import ru.raiffeisen.checkita.targets.{EmptyNotificationMessage, NotificationMessage}
