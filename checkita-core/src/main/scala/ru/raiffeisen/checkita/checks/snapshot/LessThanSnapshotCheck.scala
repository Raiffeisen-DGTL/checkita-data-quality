...
import ru.raiffeisen.checkita.checks.{Check, CheckError, CheckFailure, CheckMessageGenerator, CheckResult, CheckSuccess, CheckUtil}
...
case class LessThanThresholdCheck(
                                   ...
                                   threshold: Double
                                 )(implicit settings: DQSettings) extends LessThanSnapshotCheck {
