...
ALTER TABLE "results_metric_composed" RENAME TO "results_metric_composed_backup";
...
INSERT INTO "results_metric_composed" (
    "job_id",
    "metric_id",
    "metric_name",
    "description",
    ...
    "execution_date"
         ...
         "reference_date",
         "execution_date"
FROM "results_metric_composed_backup";
DROP TABLE "results_metric_composed_backup";
