-- SEARCH AND REPLACE schema_name WITH YOUR DESIRED SCHEMA NAME
-- SEARCH AND REPLACE <schema_dir> WITH YOUR DESIRED LOCATION
...
PARTITIONED BY (job_id STRING) USING PARQUET 
